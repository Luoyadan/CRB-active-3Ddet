...
class NuScenesDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.lidar_paths = [info['lidar_path'] for info in self.infos]
    ...
    def __getitem__(self, index):
        ...
        input_dict['sample_id_list'] = self.lidar_paths
    ...
    def create_groundtruth_database(self, used_classes=None, max_sweeps=10):
        ...
        for idx in tqdm(range(len(self.infos))):
            ...
            info_path = info['lidar_path'] # For AL GT-sampling
            ...
            for i in range(gt_boxes.shape[0]):
                ...
                if (used_classes is None) or gt_names[i] in used_classes:
                    ...
                    db_info = {'name': gt_names[i], 'path': db_path, 'image_idx': sample_idx, 'gt_idx': i,
                               'box3d_lidar': gt_boxes[i], 'num_points_in_gt': gt_points.shape[0], 'info_path': info_path}
