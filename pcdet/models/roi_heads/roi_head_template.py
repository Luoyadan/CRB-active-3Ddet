...
class RoIHeadTemplate(nn.Module):
    ...
    def proposal_layer(self, batch_dict, nms_config):
        ...
        need_energy = True if cfg.get('OPEN_WORLD',None) and cfg.OPEN_WORLD.ENABLE and cfg.OPEN_WORLD.METHOD == "energy" else False
        roi_energy = batch_box_preds.new_zeros((batch_size, nms_config.NMS_POST_MAXSIZE))
        ...
        for index in range(batch_size):
            ...
            if need_energy:
                roi_energy[index, :len(selected)] = batch_dict['energy'][batch_mask][selected]
        ...
        if need_energy:
            batch_dict['roi_energy'] = roi_energy
