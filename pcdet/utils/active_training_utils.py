...
def select_active_labels(model,
    ...
    if cfg.DATA_CONFIG.DATASET == 'KittiDataset':
        ...
        selected_id_list, selected_infos = list(strategy.labelled_set.lidar_paths), \
                                                    list(strategy.labelled_set.infos)
        unselected_id_list, unselected_infos = list(strategy.unlabelled_set.lidar_paths), \
                                                        list(strategy.unlabelled_set.infos)
    ...
    batch_size = labelled_loader.batch_size
    print("Batch_size of a single loader: %d" % (batch_size))
    workers = labelled_loader.num_workers
