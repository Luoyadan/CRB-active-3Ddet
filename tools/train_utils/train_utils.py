...
def resume_datset(labelled_loader, unlabelled_loader, selected_frames_list, dist_train, logger, cfg):
    ...
    if cfg.DATA_CONFIG.DATASET == 'KittiDataset':
        ...
        pairs = list(zip(unlabelled_set.lidar_paths, unlabelled_set.infos))

    # get selected frame id list and infos
    if cfg.DATA_CONFIG.DATASET == 'KittiDataset':
        selected_id_list, selected_infos = list(labelled_set.sample_id_list), list(labelled_set.kitti_infos)
        unselected_id_list, unselected_infos = list(unlabelled_set.sample_id_list), list(unlabelled_set.kitti_infos)
    elif cfg.DATA_CONFIG.DATASET == 'WaymoDataset': # Waymo
        selected_id_list, selected_infos = list(labelled_set.frame_ids), list(labelled_set.infos)
        unselected_id_list, unselected_infos = list(unlabelled_set.frame_ids), list(unlabelled_set.infos)
    else: # NuScenes Case
        selected_id_list, selected_infos = list(labelled_set.lidar_paths), list(labelled_set.infos)
        unselected_id_list, unselected_infos = list(unlabelled_set.lidar_paths), list(unlabelled_set.infos)
